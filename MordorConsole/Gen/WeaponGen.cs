...
namespace MordorConsole.Gen
{
    ...
    #line 1 "C:\Users\John\source\repos\MordorCore\MordorConsole\Gen\WeaponGen.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public partial class WeaponGen : WeaponGenBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            #line 6 "C:\Users\John\source\repos\MordorCore\MordorConsole\Gen\WeaponGen.tt"
    ...
    PushIndent("    "); 
    foreach (Item item in items.ItemList.Where(item => item.SubtypeID >= 0 && item.SubtypeID <= 7))
    {
        string itemName = ItemGenHelpers.RemoveBadCharacters(item.Name);
        WriteLine($"private static Weapon {itemName} => new()");
        WriteLine("{");
        PushIndent("    ");
        ...
        WriteLine($"Swings = {item.Swings},");
        WriteLine($"Attack = {item.Attack},");
        WriteLine($"Defense = {item.Defense},");
        WriteLine($"DamageMod = {item.DamageMod}f,");
    ...
    WriteLine("public IEnumerable<Weapon> GetDefaultWeapons()");
    WriteLine("{");
    PushIndent("    ");
