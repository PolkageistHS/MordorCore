...
namespace MordorConsole.Gen
{
    ...
    #line 1 "C:\Users\John\source\repos\MordorCore\MordorConsole\Gen\ArmorGen.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public partial class ArmorGen : ArmorGenBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            #line 6 "C:\Users\John\source\repos\MordorCore\MordorConsole\Gen\ArmorGen.tt"
    ...
    PushIndent("    "); 
    foreach (Item item in items.ItemList.Where(item => item.SubtypeID >= 8 && item.SubtypeID <= 20))
    {
        string itemName = ItemGenHelpers.RemoveBadCharacters(item.Name);
        WriteLine($"private static Armor {itemName} => new()");
        WriteLine("{");
        PushIndent("    ");
    ...
    WriteLine("public IEnumerable<Armor> GetDefaultArmor()");
    WriteLine("{");
    PushIndent("    ");
