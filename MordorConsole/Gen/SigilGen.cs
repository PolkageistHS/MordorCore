...
namespace MordorConsole.Gen
{
    ...
    #line 1 "C:\Users\John\source\repos\MordorCore\MordorConsole\Gen\SigilGen.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public partial class SigilGen : SigilGenBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            #line 6 "C:\Users\John\source\repos\MordorCore\MordorConsole\Gen\SigilGen.tt"
    ...
    PushIndent("    "); 
    foreach (Item item in items.ItemList.Where(item => item.SubtypeID == 34))
    {
        string itemName = ItemGenHelpers.RemoveBadCharacters(item.Name);
        WriteLine($"private static Sigil {itemName} => new()");
        WriteLine("{");
        PushIndent("    ");
    ...
    WriteLine("public IEnumerable<Sigil> GetDefaultSigils()");
    WriteLine("{");
    PushIndent("    ");
